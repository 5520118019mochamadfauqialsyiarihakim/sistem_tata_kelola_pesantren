...
@section('page')
  <li class="breadcrumb-item active"><a href="{{ route('ustadz.index') }}">Ustadz</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    @if (Auth::user()->role == 'Ustadz')
                        ...
                        <img src="{{ asset(Auth::user()->ustadz(Auth::user()->id_card)->foto) }}" class="img img-responsive" alt="" width="30%" />
                    @else
                        <input type="hidden" name="role" value="{{ Auth::user()->role }}">
