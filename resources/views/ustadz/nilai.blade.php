                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label for="nama_gur">Nama Ustadz/Ustadzah</label>
                            <input type="text" id="nama_gur" name="nama_gur" value="{{ $ustadz->nama_ustadz }}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                            <label for="ustadz_id">Kode Mapel</label>
                            <input type="text" id="ustadz_id" name="ustadz_id" value="{{ $ustadz->kode }}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="mapel" name="mapel" value="{{ $ustadz->mapel->nama_mapel }}" class="form-control" readonly>
                        </div>
                        <div class="form-group">
