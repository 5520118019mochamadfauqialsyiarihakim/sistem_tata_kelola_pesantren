...
@section('heading', 'Absen Harian Ustadz')
@section('page')
  <li class="breadcrumb-item active">Absen Harian Ustadz/Ustadzah</li>
@endsection
@section('content')
@php
    $no = 1;
...
<div class="col-md-6">
    <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">Absen Harian Ustadz/Ustadzah</h3>
      </div>
      <form action="{{ route('absen.simpan') }}" method="post">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="text" id="id_card" name="id_card" maxlength="5" onkeypress="return inputAngka(event)" class="form-control @error('id_card') is-invalid @enderror" value="{{ Auth::user()->id_card }}">
            </div>
            <div class="form-group">
