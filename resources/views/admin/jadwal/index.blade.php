                  ...
                  <div class="card card-outline card-primary">
                      ...
                      <div class="card-body">
                          <ul>
                              ...
                              <li>rows 4 = nama ustadz/ustadzah</li>
          ...
          <form action="{{ route('jadwal.store') }}" method="post">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  <label for="ustadz_id">Ustadz dan Kode Mapel</label>
                  <select id="ustadz_id" name="ustadz_id" class="form-control @error('ustadz_id') is-invalid @enderror select2bs4">
                      <option value="">-- Pilih Ustadz dan Kode Mapel --</option>
                      @foreach ($ustadz as $data)
                          <option value="{{ $data->id }}">{{ $data->nama_ustadz }} - {{ $data->kode }}</option>
                      @endforeach
                  </select>
                </div>
              </div>
