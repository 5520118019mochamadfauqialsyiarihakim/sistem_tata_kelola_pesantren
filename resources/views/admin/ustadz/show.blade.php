            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{-- http://127.0.0.1:8000/ustadz/ubah-foto/{{$data->id}} --}}
                    </td>
                    <td>
                        <form action="{{ route('ustadz.destroy', $data->id) }}" method="post">
                            @csrf
                            @method('delete')
                            <a href="{{ route('ustadz.show', Crypt::encrypt($data->id)) }}" class="btn btn-info btn-sm mt-2"><i class="nav-icon fas fa-id-card"></i> &nbsp; Detail</a>
                            <a href="{{ route('ustadz.edit', Crypt::encrypt($data->id)) }}" class="btn btn-success btn-sm mt-2"><i class="nav-icon fas fa-edit"></i> &nbsp; Edit</a>
