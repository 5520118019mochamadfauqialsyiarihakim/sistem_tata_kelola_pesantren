...
<div class="col-md-12">
    ...
    <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form action="{{ route('ustadz.update-foto', $ustadz->id) }}"  enctype="multipart/form-data" method="post">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_ustadz" class="form-control" value="{{ $ustadz->nama_ustadz }}" readonly>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <img src="{{ asset($ustadz->foto) }}" class="img img-responsive" alt="" width="30%" />
                </div>
            </div>
        </div>
        <!-- /.card-body -->
        ...
        <div class="card-footer">
            <a href="{{ route("ustadz.index") }}" class="btn btn-default"><i class='nav-icon fas fa-arrow-left'></i> &nbsp; Kembali</a> &nbsp;
