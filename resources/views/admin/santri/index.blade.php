    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                ...
                <a href="{{ route('santri.export_excel') }}" class="btn btn-success btn-sm my-3" target="_blank"><i class="nav-icon fas fa-file-export"></i> &nbsp; EXPORT EXCEL</a>
            ...
            <tbody>
                @foreach ($kelas as $data)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('santri.kelas', Crypt::encrypt($data->id)) }}" class="btn btn-info btn-sm"><i class="nav-icon fas fa-search-plus"></i> &nbsp; Details</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="nama_santri" name="nama_santri" class="form-control @error('nama_santri') is-invalid @enderror">
                    </div>
                    <div class="form-group">
                        <label for="tahun_masuk">Tahun Masuk</label>
                        <input type="text" id="tahun_masuk" name="tahun_masuk" onkeypress="return inputAngka(event)" class="form-control @error('tahun_masuk') is-invalid @enderror">
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="smt" name="smt" onkeypress="return inputAngka(event)" class="form-control @error('smt') is-invalid @enderror">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="id_kamar">Kamar Santri</label>
                        <select id="id_kamar" name="id_kamar" class="select2bs4 form-control   is-invalid " required="">
                            ...
                            <?php                                    
                                ...
                                if($result1 = $mysqli->query("SELECT * FROM kamar")){
