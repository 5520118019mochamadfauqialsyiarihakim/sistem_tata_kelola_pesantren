    ...
    <div class="card card-primary">
      ...
      <form action="{{ route('santri.update-foto', $santri->id) }}"  enctype="multipart/form-data" method="post">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_santri" class="form-control" value="{{ $santri->nama_santri }}" readonly>
                    </div>
                    <div class="form-group">
        ...
        <div class="card-footer">
            <a href="{{ route("santri.index") }}" class="btn btn-default"><i class='nav-icon fas fa-arrow-left'></i> &nbsp; Kembali</a> &nbsp;
