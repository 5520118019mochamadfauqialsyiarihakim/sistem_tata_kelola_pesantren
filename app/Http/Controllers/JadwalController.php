...
class JadwalController extends Controller
{
    ...
    public function index()
    {
        ...
        $ruang = Ruang::all();
        $ustadz = Ustadz::OrderBy('kode', 'asc')->get();
        return view('admin.jadwal.index', compact('hari', 'kelas', 'ustadz', 'ruang'));
    }
    ...
    public function edit($id)
    {
        ...
        $ruang = Ruang::all();
        $ustadz = Ustadz::OrderBy('kode', 'asc')->get();
        return view('admin.jadwal.edit', compact('jadwal', 'hari', 'kelas', 'ustadz', 'ruang'));
    }
    ...
    public function ustadz()
    {
        ...
        $jadwal = Jadwal::orderBy('hari_id')->OrderBy('jam_mulai')->where('ustadz_id', $ustadz->id)->get();
        return view('ustadz.jadwal', compact('jadwal', 'ustadz'));
    }
